...
import GeocoderInput from "../filters/GeocoderInput";
      ...
      {clusters.map((cluster) => {
          ...
          return (
            ...
            >
              <div
                ...
                style={{
                  width: `${10 + (point_count / points.length) * 2}px`,
                  height: `${10 + (point_count / points.length) * 2}px`,
                }}
                onClick={() => {
                  const zoom = Math.min(
        ...
        return (
          <Marker
            ...
            latitude={latitude}
          >
            <Tooltip title={cluster.properties.type}>
              <Paper
