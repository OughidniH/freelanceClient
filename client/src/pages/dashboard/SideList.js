...
// import Freelances from "./freelances/DashFreeList";
import ListFreelances from "./freelances/ListFreelances";
  ...
  const list = useMemo(
    () => [
      ...
      },
      {
        ...
        link: "freelances", // link URL
        component: <ListFreelances {...{ setSelectedLink, link: "freelances" }} />,
      },
      // {
      //   title: "Requests",
